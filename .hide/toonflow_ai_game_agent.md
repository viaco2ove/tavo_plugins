# Toonflow-game 可以用于参考设计tavo_plugins
主要是 D:\Users\viaco\tools\Toonflow-game\toonflow-game-app

```
web_project: /mnt/d/users/viaco/tools/Toonflow-game/Toonflow-game-web
...
D:\Users\viaco\tools\Toonflow-game\toonflow-game-app\md\curr_design\剧情编排\自由模式\世界书\复刻酒馆\世界知识_agent.md

# Toonflow-game的提示词是fixDB.prompts.ts 维护的。可以用于参考设计tavo_plugins
